...
import Foundation
    ...
    enum JSONSchemaConverter {
        ...
        static func convert(_ schema: [String: Any]) throws -> DynamicGenerationSchema {
            ...
            case "object":
                ...
                let properties: [DynamicGenerationSchema.Property] = propertiesDict.compactMap { key, value in
                    ...
                    let isOptional = !requiredList.contains(key)
        ...
        /// Validates that the schema is accepted by GenerationSchema (used by tests and call sites).
        static func validateForGenerationSchema(_ schema: DynamicGenerationSchema) throws {
